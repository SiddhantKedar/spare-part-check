...
def index():
    if request.method == "POST":
        ...
        option_code_inverter = pd.read_excel(xls, sheet_name="Option Code_inverter")
        mvps_spare = pd.read_excel(xls, sheet_name="MVPS spare", skiprows=1, header=0)
        ...
        matched_df = pd.DataFrame(matched_spares)
